...
@Component({
  ...
  templateUrl: './loadwallet.page.html',
  styleUrls: ['./loadwallet.page.scss'],
})
...
this.UserService.presentAlert('Please select card')
   ...
   audio.pause()
        let navigationExtras: NavigationExtras = {
          queryParams: {
            message:'You have added' + ' $'+this.number + ' from card to wallet'
          }
        }
...
this.UserService.presentAlert('Please select bank')
   ...
   audio.pause()
        let navigationExtras: NavigationExtras = {
          queryParams: {
            message:'You have added' + ' $'+this.number + ' from Bank to wallet'
          }
        }
      this.navCtrl.navigateForward('success', navigationExtras)
